    ...
    public static class PeliculasEndpoints
    {
        ...
        public static RouteGroupBuilder MapPeliculas(this RouteGroupBuilder group)
        {
            ...
            group.MapGet("/filtrar", FiltrarPeliculas)
                .AgregarParametrosPeliculasOpenApi();
        ...
        static async Task<Results<NoContent, NotFound, BadRequest<string>>> AsignarActores(int id,
            ...
            IRepocitorioActores repocitorioActores, IMapper mapper)
        {
            if (!await repositorioPeliculas.Existe(id))
            {
                return TypedResults.NotFound();
            ...
            {
                actoresExistentes = await repocitorioActores.Existen(actoresIds);
            }
        ...
        static async Task<IResult>FiltrarPeliculas(PeliculasFiltrarDTO peliculasFiltrarDTO,
